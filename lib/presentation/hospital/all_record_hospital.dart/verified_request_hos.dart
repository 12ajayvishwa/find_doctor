...
class VerifiedRequestOfHos extends StatefulWidget {
  const VerifiedRequestOfHos({super.key});

  @override
  State<VerifiedRequestOfHos> createState() => _VerifiedRequestOfHosState();
}

class _VerifiedRequestOfHosState extends State<VerifiedRequestOfHos> {
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      requestController.getRequest(status: "approved");
    });
    ...
    return Scaffold(
      body: Column(children: [
        appBarContainer(size,
            title: "Hospital Verified Requests", isLeading: true),
        Padding(
