...
class RequestVerificationStatusScreen extends StatefulWidget {
  const RequestVerificationStatusScreen({super.key});

  @override
  State<RequestVerificationStatusScreen> createState() =>
      _RequestVerificationStatusScreenState();
}

class _RequestVerificationStatusScreenState
    extends State<RequestVerificationStatusScreen> {
    ...
    return Scaffold(
      body: Column(children: [
        appBarContainer(size,
            title: "Request Verification Status", isLeading: true),
        Padding(
